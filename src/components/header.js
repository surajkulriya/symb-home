...
export default function Header() {
  ...
  <Navbar.Brand href="#home"><img src="vector-smart-object_3@3x.jpg" style={{ width: "70%", height: "auto" }} alt="yo"></img></Navbar.Brand>
  {/* <Navbar.Toggle aria-controls="basic-navbar-nav" /> */}
  <Navbar.Collapse id="basic-navbar-nav">
    
    <div class="nav navbar-nav navbar-right pull-right">
    <Nav className="mr-sm-2" style={{float:"right"}}>
      <Nav.Link href="#home" class="pull-right" style={{color:"black",fontSize:"90%",fontWeight:"bold",padding:"2% 2%",float:"right"}}>Who are we?</Nav.Link>
      <Nav.Link href="#link" style={{color:"black",fontSize:"90%",fontWeight:"bold"}}>What do we do?</Nav.Link>
